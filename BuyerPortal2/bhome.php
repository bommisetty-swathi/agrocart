...
.container .text-center h1.guard,
.container .text-center h1.longguard {
    background-color: black;
    color: white;
    padding: 10px; /* Add padding for better visibility */
}

.container .text-center h1.guard span,
.container .text-center h1.longguard span {
    border: 2px solid white; /* Add a white border around the text */
...
.container .text-center h1.longguard span {
    ...
    color: black;
    padding: 10px; /* Add padding for better visibility */
    border: 2px solid black; /* Add a black border around the text */
    border-radius: 8px; /* Add border-radius for rounded corners */
}

.container .text-center h1.guard span:hover,
.container .text-center h1.longguard span:hover {
    background-color: black;
    color: white;
}
...
.container .BigBox {
    ...
    border: 2px solid black; /* Add a black border around the content */
    border-radius: 8px; /* Add border-radius for rounded corners */
}

.container .BigBox:hover {
    background-color: black;
    color: white;
}

/* Adjust styles as needed based on your design preferences */
...
<body>
    ...
    <div class="container"> <img src="bb.jpg" class="img-fluid firstimage d-block mx-auto" alt="Responsive image">
    </div>
    <br>
    <br>
