 ...
 <head>
      ...
      <style>
           * {
           ...
           .f1 {
                ...
                padding-top: 20px;
                border-style: solid;
                background-image: url("fruitsandveg.jpg");
    ...
    .navbar-link {
        ...
        border: 1px solid white; /* Adding a border for creativity */
        border-radius: 8px; /* Rounded corners */
        margin: 5px; /* Spacing between menu items */
    }
    ...
    .fa {
        font-size: 28px; /* Slightly decreased icon size */
    }
    ...
    .features {
        ...
        border-radius: 15px;
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
        margin: 20px auto; /* Center the features */
    }
    ...
    body {
    background-image: url(../Images/Homepage/farm.jpg);
    background-repeat: no-repeat;
 ...
 <body>
      ...
      <body>
           ...
           <br>
           <div class="row text-center" id="navbar-container">
    <div class="col-md-3 col-sm-12">
        <a href="farmerHomepage.php" class="navbar-link">
            <i class="fa fa-home" aria-hidden="true"></i>
            <label class="navbar-label">Home</label>
        </a>
    </div>

    <div class="col-md-3 col-sm-12">
        <a href="MyProducts.php" class="navbar-link">
            <i class="fa fa-leaf" aria-hidden="true"></i>
            <label class="navbar-label">My Products</label>
        </a>
    </div>

    <div class="col-md-3 col-sm-12">
        <a href="Transactions.php" class="navbar-link">
            <i class="fa fa-exchange" aria-hidden="true"></i>
            <label class="navbar-label">My Transactions</label>
        </a>
    </div>

    <div class="col-md-3 col-sm-12">
        <a href="CallCenter.php" class="navbar-link">
            <i class="fa fa-phone fa-rotate-vertical" aria-hidden="true"></i>
            <label class="navbar-label">Call Centers/SMS</label>
        </a>
    </div>
</div>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                          <div class="carousel-item active">
                               <img class="d-block w-100 resizing" src="../Images/Homepage/fruitbaskect1.jpg" alt="First slide">
                          </div>
    ...
    <h1 class="app-title">Awesome Features of Our Application</h1>
    <div class="card-deck row text-center" style="display: flex; flex-wrap: wrap; justify-content: center;">

        <div class="card feature-card">
            <div class="feature-image-container">
                <img class="card-img-top image" src="../Images/Homepage/s1.png" alt="Card image cap">
            </div>
            <div class="card-body">
                <h4 class="card-title font-weight-bold">Sms System</h4>
                <p class="card-text">Effortlessly upload and edit your products via SMS</p>
            </div>
        </div>

        <div class="card feature-card">
            <div class="feature-image-container">
                <img class="card-img-top image" src="../Images/Homepage/buyer.png" alt="Card image cap">
            </div>
            <div class="card-body">
                <h4 class="card-title font-weight-bold">Buyer Connection</h4>
                <p class="card-text">Directly engage with buyers to meet their needs</p>
            </div>
        </div>
        ...
        <div class="card feature-card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">Build a community with fellow farmers for support and collaboration</p>
            </div>
        </div>
...
<br> <br>
<section id="footer" class="myfooter" style="background-color: black; color: white;">
    <div class="container">
