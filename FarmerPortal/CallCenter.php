...
<head>
     ...
     <style>
          * {
          ...
          body {
               ...
               box-sizing: border-box;
               background-image: url("../Images/Homepage/sms1.jpg");
    ...
    body {
    background-image: url("C:\xampp\htdocs\Agrocraft-An-E-Commerce-Website-For-Fresh-Farm-Produce-Vegetables-And-Fruits-master\BuyerPortal2\cart.jpg");
    background-repeat: no-repeat;
    background-position: center center;
    text-align: center;
    background-size: 100% 100%;
    ...
    .card {
        ...
        border: 1px solid #3498db; /* Border color for the card */
        border-radius: 10px; /* Border-radius for rounded corners */
        box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); /* Box shadow for depth */
    }

    .card-header {
        background-color: #3498db; /* Blue background color for the card header */
        color: #fff; /* White text color for the card header */
    }

    .card-deck .card {
        border: none; /* Remove borders between cards */
    }

    .card-body {
        color: #333; /* Dark blue text color for the card body */
    }

    .card-title {
        color: #3498db; /* Light blue text color for the card title */
    }

    .card-text {
        color: #555; /* Medium blue text color for the card text */
    }

    hr {
        border-top: 1px solid #3498db; /* Blue color for the divider line */
        margin-top: 20px;
        margin-bottom: 20px;
    }
    body{
